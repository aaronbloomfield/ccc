...
Just to check: at this point, you should have TWO geth processes running in separate windows.  The first is the full node with the five additional flags as above. The second is a geth terminal via `geth attach`.
