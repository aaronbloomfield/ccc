...
--http.corsdomain="package://0123456789abcdef0123456789abcdef.mod"`.  HOWEVER, the particular package hex string will vary by OS and version.  This flag will be presented to you by Remix when you switch over to deploy through the local geth node, described below.  If you are using the Desktop version, you will have to restart your geth node with that flag.
