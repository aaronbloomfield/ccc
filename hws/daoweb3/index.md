...
- That you have a working account on the CS departmental servers.  If you are unsure, you can view the CS computing page, which has a link to the password reset page (a link to there is in the blockchain explorer's links section)
...
The links to all of these are in the blockchain explorer's links section.
