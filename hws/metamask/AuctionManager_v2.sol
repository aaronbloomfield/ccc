...
interface AuctionManager_v2 is IERC165, IERC721Receiver {

    //------------------------------------------------------------
    // Updates needed for the MetaMask assignment

    function lastMintedNFT(address a) external view returns (uint);
