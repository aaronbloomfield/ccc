...
- [![](../slides/images/logos/btc-coin-symbol.svg){fig-alt='btc logo'}](https://coinmarketcap.com/currencies/bitcoin/){class="cclogo-slide"}
 Bitcoin: we all know this
  - Hash algorithm: double SHA-256
- [![](../slides/images/logos/rvn-coin-symbol.svg){fig-alt='rvn logo'}](https://coinmarketcap.com/currencies/ravencoin/){class="cclogo-slide"}
 Ravencoin
...
- [![](../slides/images/logos/eth-coin-symbol.svg){fig-alt='eth logo'}](https://coinmarketcap.com/currencies/ethereum/){class="cclogo-slide"}
 Ethereum
...
- [![](../slides/images/logos/xpm-coin-symbol.svg){fig-alt='xpm logo'}](https://coinmarketcap.com/currencies/primecoin/){class="cclogo-slide"} Example: Primecoin, launched in 2013 <br clear='all'>
...
- [![](../slides/images/logos/rvn-coin-symbol.svg){fig-alt='rvn logo'}](https://coinmarketcap.com/currencies/ravencoin/){class="cclogo-slide"} Consider Ravencoin, which aims for ASIC-resistant mining <br clear='all'>
...
## [![](../slides/images/logos/eth-coin-symbol.svg){fig-alt='eth logo'}](https://coinmarketcap.com/currencies/ethereum/){class="cclogo-slide"} Ethereum and PoS
...
## [![](../slides/images/logos/eth-coin-symbol.svg){fig-alt='eth logo'}](https://coinmarketcap.com/currencies/ethereum/){class="cclogo-slide"} Ethereum's move to PoS
...
## [![](../slides/images/logos/ppc-coin-symbol.svg){fig-alt='ppc logo'}](https://coinmarketcap.com/currencies/peercoin/){class="cclogo-slide"} Peercoin
...
## Proof-of-History
- In ![](../slides/images/logos/sol-coin-symbol.svg#cclogo){class="cclogo-slide" alt='SOL logo'} Solana ([SOL](https://coinmarketcap.com/currencies/solana/)) the block verification combines PoS and proof of history ([Solana's whitepaper](https://solana.com/solana-whitepaper.pdf))
...
- With ![](../slides/images/logos/btc-coin-symbol.svg#cclogo){class="cclogo-slide" alt='BTC logo'} Bitcoin, we have to compute the Merkle tree hash
  - Given $n$ transactions, it takes $\Theta(n)$ steps to build the tree
  - Given infinite computing power, it takes $\Theta(\log n)$ steps
- In ![](../slides/images/logos/sol-coin-symbol.svg#cclogo){fig-alt='SOL logo'} Solana, each transaction can be verified in parallel
...
- [![](../slides/images/logos/storj-coin-symbol.svg){fig-alt='storj logo'}](https://coinmarketcap.com/currencies/storj/){class="cclogo-slide"} Example: Storj
...
- [![](../slides/images/logos/fil-coin-symbol.svg){fig-alt='fil logo'}](https://coinmarketcap.com/currencies/filecoin/){class="cclogo-slide"} Example: Filecoin



## [![](../slides/images/logos/neox-coin-symbol.svg){fig-alt='neox logo'}](https://coinmarketcap.com/currencies/neoxa/){class="cclogo-slide"} Neoxa: "Proof-of-Game"
...
- Possibilities:
  ...
  - Does not require proofs, such as [![](../slides/images/logos/xlm-coin-symbol.svg){fig-alt='xlm logo'}](https://coinmarketcap.com/currencies/stellar/){class="cclogo-slide"}
 Stellar Lumens (XLM)
...
- Consider the [![](../slides/images/logos/rvn-coin-symbol.svg){fig-alt='rvn logo'}](https://coinmarketcap.com/currencies/ravencoin/){class="cclogo-slide" alt='RVN logo'} Ravencoin [pool from 2miners](https://2miners.com/rvn-mining-pool)
...
- [![](../slides/images/logos/firo-coin-symbol.svg){fig-alt='firo logo'}](https://coinmarketcap.com/currencies/firo/){class="cclogo-slide" alt='FIRO logo'} Firo had one in January 2021
- [![](../slides/images/logos/btg-coin-symbol.svg){fig-alt='btg logo'}](https://coinmarketcap.com/currencies/bitcoin-gold/){class="cclogo-slide" alt='BTG logo'} Bitcoin Gold had one in May 2018 and January 2020
...
- Number of confirmations typically required (via [2miners](https://2miners.com)):
  - [![](../slides/images/logos/xlm-coin-symbol.svg){fig-alt='xlm logo'}](https://coinmarketcap.com/currencies/stellar/){class="cclogo-slide" alt='XLM logo'} XLM: 0 blocks (5 seconds) (TXNs are irreversible)
  - [![](../slides/images/logos/btc-coin-symbol.svg){fig-alt='btc logo'}](https://coinmarketcap.com/currencies/bitcoin/){class="cclogo-slide" alt='BTC logo'} BTC: 6 blocks (about 1 hour) for "standard" transactions
  - [![](../slides/images/logos/eth-coin-symbol.svg){fig-alt='eth logo'}](https://coinmarketcap.com/currencies/ethereum/){class="cclogo-slide" alt='ETH logo'} ETH: 240 blocks (about 1 hour) (maybe different w/PoS)
  - [![](../slides/images/logos/rvn-coin-symbol.svg){fig-alt='rvn logo'}](https://coinmarketcap.com/currencies/ravencoin/){class="cclogo-slide"} RVN: 100 blocks (about 2 hours)
  - [![](../slides/images/logos/firo-coin-symbol.svg){fig-alt='firo logo'}](https://coinmarketcap.com/currencies/firo/){class="cclogo-slide"} FIRO: 100 blocks (about 9 hours)
  - [![](../slides/images/logos/btc-coin-symbol.svg){fig-alt='btc logo'}](https://coinmarketcap.com/currencies/bitcoin/){class="cclogo-slide"} BTC: 60 blocks (about 10 hours) for "large" transactions
  - [![](../slides/images/logos/erg-coin-symbol.svg){fig-alt='erg logo'}](https://coinmarketcap.com/currencies/ergo/){class="cclogo-slide"} ERG: 720 blocks (about 1 day)
...
<!-- .slide: class="cclogo-slide" -->
## [![](../slides/images/logos/eth-coin-symbol.svg){fig-alt='eth logo'}](https://coinmarketcap.com/currencies/ethereum/){class="cclogo-slide"} Ethereum & <br> [![](../slides/images/logos/etc-coin-symbol.svg){fig-alt='etc logo'}](https://coinmarketcap.com/currencies/ethereum-classic/){class="cclogo-slide"} Ethereum Classic
...
- [![](../slides/images/logos/etc-coin-symbol.svg){fig-alt='etc logo'}](https://coinmarketcap.com/currencies/ethereum-classic/){class="cclogo-slide"} Ethereum Classic is the blockchain *without* the fix
- [![](../slides/images/logos/eth-coin-symbol.svg){fig-alt='eth logo'}](https://coinmarketcap.com/currencies/ethereum/){class="cclogo-slide"} Ethereum is the blockchain *with* the fix



<!-- .slide: class="cclogo-slide" -->
## [![](../slides/images/logos/btg-coin-symbol.svg){fig-alt='btg logo'}](https://coinmarketcap.com/currencies/bitcoin-gold/){class="cclogo-slide"} Bitcoin Gold
...
- The [![](../slides/images/logos/rvn-coin-symbol.svg){fig-alt='rvn logo'}](https://coinmarketcap.com/currencies/ravencoin/){class="cclogo-slide"} [Ravencoin (RVN) source code](https://github.com/RavenProject/Ravencoin) is based off of the [Bitcoin source code](https://github.com/bitcoin/bitcoin); created in 2018
- Changes:
  - 1000x as many coins
...
<!-- .slide: class="cclogo-slide" -->
## [![](../slides/images/logos/nmc-coin-symbol.svg){fig-alt='nmc logo'}](https://coinmarketcap.com/currencies/namecoin/){class="cclogo-slide"} Namecoin (2011)
