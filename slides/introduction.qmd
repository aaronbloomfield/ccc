...
![](images/logos/eth-coin-symbol.svg){fig-alt='eth logo'}
:::
...
![](images/overview/bitcoin-coin.webp){fig-alt='bitcoin symbol'}
:::

- ...in 2010 for $0.25 per BTC
  - Let's say you spent $100
  - You would have owned 400 BTC
- That would be worth over $36 million today!
  - (assuming [a price of $91k per BTC](https://coinmarketcap.com/currencies/bitcoin/))
...
- This course will primarily focus on the technical aspects of two coins / networks:
  - <a href='https://coinmarketcap.com/currencies/bitcoin/'><img src="images/logos/btc-coin-symbol.svg" alt="btc symbol" style="display:inline-block;float:left;margin-right:20px;width:100px"></a> Bitcoin (BTC, &#8383;): the first real viable cryptocurrency and the most valuable; ASIC mineable <br clear='all'>
  - <a href='https://coinmarketcap.com/currencies/ethereum/'><img src="images/logos/eth-coin-symbol.svg" alt="eth symbol" style="display:inline-block;float:left;margin-right:30px;width:100px"></a> Ethereum (ETH, &Xi;): has significant improvements over Bitcoin with much more functionality; no longer ASIC mineable <br clear='all'>
...
[![](images/logos/algo-coin-symbol.svg#cclogomed){fig-alt="algo logo"}](https://coinmarketcap.com/currencies/algorand/)
[![](images/logos/atom-coin-symbol.svg#cclogomed){fig-alt="atom logo"}](https://coinmarketcap.com/currencies/cosmos/)
[![](images/logos/aust-coin-symbol.svg#cclogomed){fig-alt="aust logo"}](https://coinmarketcap.com/currencies/anchorust/)
[![](images/logos/beam-coin-symbol.svg#cclogomed){fig-alt="beam logo"}](https://coinmarketcap.com/currencies/beam/)
[![](images/logos/btc-coin-symbol.svg#cclogomed){fig-alt="btc logo"}](https://coinmarketcap.com/currencies/bitcoin/)
[![](images/logos/btg-coin-symbol.svg#cclogomed){fig-alt="btg logo"}](https://coinmarketcap.com/currencies/bitcoin-gold/)
[![](images/logos/dai-coin-symbol.svg#cclogomed){fig-alt="dai logo"}](https://coinmarketcap.com/currencies/multi-collateral-dai/)
[![](images/logos/dot-coin-symbol.svg#cclogomed){fig-alt="dot logo"}](https://coinmarketcap.com/currencies/polkadot-new/)
[![](images/logos/erg-coin-symbol.svg#cclogomed){fig-alt="erg logo"}](https://coinmarketcap.com/currencies/ergo/)
[![](images/logos/etc-coin-symbol.svg#cclogomed){fig-alt="etc logo"}](https://coinmarketcap.com/currencies/ethereum-classic/)
[![](images/logos/eth-coin-symbol.svg#cclogomed){fig-alt="eth logo"}](https://coinmarketcap.com/currencies/ethereum/)
[![](images/logos/fei-coin-symbol.svg#cclogomed){fig-alt="fei logo"}](https://coinmarketcap.com/currencies/fei-usd/)
[![](images/logos/fil-coin-symbol.svg#cclogomed){fig-alt="fil logo"}](https://coinmarketcap.com/currencies/filecoin/)
[![](images/logos/firo-coin-symbol.svg#cclogomed){fig-alt="firo logo"}](https://coinmarketcap.com/currencies/firo/)
[![](images/logos/frax-coin-symbol.svg#cclogomed){fig-alt="frax logo"}](https://coinmarketcap.com/currencies/frax/)
[![](images/logos/juno-coin-symbol.svg#cclogomed){fig-alt="juno logo"}](https://coinmarketcap.com/currencies/juno/)
[![](images/logos/lunac-coin-symbol.svg#cclogomed){fig-alt="luna logo"}](https://coinmarketcap.com/currencies/terra-luna/)
[![](images/logos/matic-coin-symbol.svg#cclogomed){fig-alt="matic logo"}](https://coinmarketcap.com/currencies/polygon/)
[![](images/logos/mim-coin-symbol.svg#cclogomed){fig-alt="mim logo"}](https://coinmarketcap.com/currencies/magic-internet-money/)
[![](images/logos/mkr-coin-symbol.svg#cclogomed){fig-alt="mkr logo"}](https://coinmarketcap.com/currencies/maker/)
[![](images/logos/neox-coin-symbol.svg#cclogomed){fig-alt="neox logo"}](https://coinmarketcap.com/currencies/neoxa/)
[![](images/logos/nmc-coin-symbol.svg#cclogomed){fig-alt="nmc logo"}](https://coinmarketcap.com/currencies/namecoin/)
[![](images/logos/ppc-coin-symbol.svg#cclogomed){fig-alt="ppc logo"}](https://coinmarketcap.com/currencies/peercoin/)
[![](images/logos/rvn-coin-symbol.svg#cclogomed){fig-alt="rvn logo"}](https://coinmarketcap.com/currencies/ravencoin/)
[![](images/logos/sai-coin-symbol.svg#cclogomed){fig-alt="sai logo"}](https://coinmarketcap.com/currencies/single-collateral-dai/)
[![](images/logos/shib-coin-symbol.svg#cclogomed){fig-alt="shib logo"}](https://coinmarketcap.com/currencies/shiba-inu/)
[![](images/logos/sol-coin-symbol.svg#cclogomed){fig-alt="sol logo"}](https://coinmarketcap.com/currencies/solana/)
[![](images/logos/spell-coin-symbol.svg#cclogomed){fig-alt="spell logo"}](https://coinmarketcap.com/currencies/spell-token/)
[![](images/logos/storj-coin-symbol.svg#cclogomed){fig-alt="storj logo"}](https://coinmarketcap.com/currencies/storj/)
[![](images/logos/tomb-coin-symbol.svg#cclogomed){fig-alt="tomb logo"}](https://coinmarketcap.com/currencies/tomb/)
[![](images/logos/tribe-coin-symbol.svg#cclogomed){fig-alt="tribe logo"}](https://coinmarketcap.com/currencies/tribe/)
[![](images/logos/usdc-coin-symbol.svg#cclogomed){fig-alt="usdc logo"}](https://coinmarketcap.com/currencies/usd-coin/)
[![](images/logos/usdt-coin-symbol.svg#cclogomed){fig-alt="usdt logo"}](https://coinmarketcap.com/currencies/tether/)
[![](images/logos/ustc-coin-symbol.svg#cclogomed){fig-alt="ustc logo"}](https://coinmarketcap.com/currencies/terrausd/)
[![](images/logos/wbtc-coin-symbol.svg#cclogomed){fig-alt="wbtc logo"}](https://coinmarketcap.com/currencies/wrapped-bitcoin/)
[![](images/logos/weth-coin-symbol.svg#cclogomed){fig-alt="weth logo"}](https://coinmarketcap.com/currencies/weth/)
[![](images/logos/xlm-coin-symbol.svg#cclogomed){fig-alt="xlm logo"}](https://coinmarketcap.com/currencies/stellar/)
[![](images/logos/xpd-coin-symbol.svg#cclogomed){fig-alt="xpd logo"}](https://coinmarketcap.com/currencies/petrodollar/)
[![](images/logos/xpm-coin-symbol.svg#cclogomed){fig-alt="xpm logo"}](https://coinmarketcap.com/currencies/primecoin/)
[![](images/logos/zec-coin-symbol.svg#cclogomed){fig-alt="zec logo"}](https://coinmarketcap.com/currencies/zcash/)



## Cryptocurrency Market Cap

<img src="images/timely/cc-market-cap.webp" class="stretch" style="padding:0" alt="CC market cap graph">
...
<img src="images/timely/cc-market-cap-no-btc.svg" class="stretch" style="padding:0" alt="CC market cap graph, not counting bitcoin">
...
<img src="images/timely/btc-dominance.webp" class="stretch" style="padding:0" alt="BTC dominance, which has generally been 50% or higher">
...
<img src="images/introduction/aaronbloomfield.jpg" style="padding:0;margin:auto;height:35vh" alt="A picture of Aaron Bloomfield">
...
## Meetings
- Lectures: Tu/Th 9:30-10:45 in Olsson 120
...
## Expectations
- Prerequisites: CS 3100 (DSA2), with a grade of C- or higher
...
- Grades are computed by:
  - 10% class participation (in-class quizzes, attendance)
  - 35% homeworks
  - 25% midterm: Tuesday, March 10th, in class
  - 30% final exam: Monday, May 4th, from 2pm - 5pm
...
- Soon (but not ready yet!): start on [HW P1: Introduction](../hws/intro/index.html)
  ...
  - Due the Tuesday, January 29th (the third week of the semester)
...
- You may submit 6 of them up to 4 days late with no penalty
  - You have to fill out a an online extension request up to 4 days after the (original) due date
...
::: right-float-img-600
[![](images/introduction/bitcoin-mining.svg)](https://vectorportal.com/vector/bitcoin-mining/36004){fig-alt="an image of rock mining tools"}
:::


- "Mining" cryptocurrency is a process by which a computer performs significant computations to help the cryptocurrency
