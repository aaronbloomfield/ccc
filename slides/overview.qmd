...
![](images/tokens/dollar-bill.webp){alt='dollar bill image'}
:::
...
![](images/overview/aaron-dollar.png){alt='AaronDollar(TM) image'}
:::
...
::: {.cclogosubtitle}
![](images/logos/btc-coin-symbol.svg){alt="BTC logo"}
:::
...
![](https://upload.wikimedia.org/wikipedia/commons/7/77/Satoshi_Nakamoto.jpg){alt='picture of satoshi nakamoto statue'}
:::
...
![BTC price](images/timely/btc-price.webp){alt='btc price graph'}
...
::: {.right-float-img-nb-400}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Czech_Wallet.jpg/800px-Czech_Wallet.jpg){alt='image of a billfold wallet'}
:::
...
## Simple Blockchain
::: {.right-float-img}
![](images/overview/graphs/overview.dot.1.svg){alt='simple image of a blockchain'}
:::
...
![](https://upload.wikimedia.org/wikipedia/commons/d/dc/WA_archery_target_with_arrows.jpg){alt='picture of an archery target'}
:::
...
::: {.right-float-img-nb-400}
![](https://upload.wikimedia.org/wikipedia/commons/4/48/Gigabyte_GTX_970_Windforce.jpg){alt='picture of a video card'}
:::
...
## Electricity usage
::: {.right-float-img-nb-300}
![](https://upload.wikimedia.org/wikipedia/commons/6/6b/Electricity_pylons2.jpg){alt='picture of electricity poles'}
:::
...
![BTC difficulty, all time](images/timely/btc-difficulty-all-time.webp){alt='BTC difficulty graph'}
<!-- change each semester -->
...
![BTC difficulty, last 2 years](images/timely/btc-difficulty-last-3-years.webp){alt='BTC difficulty graph'}
<!-- change each semester -->
...
![hashes per second](images/timely/btc-hashes-per-sec.webp){alt='hashes per second graph'}



## Mining hardware
::: {.right-float-img-nb-400}
![](https://m.media-amazon.com/images/I/61WsmRwaOaL._AC_SL1000_.jpg){alt='picture of an ASIC miner'}
:::
